...
class IndicatorVirtualBox( IndicatorBase ):
    ...
    def __init__( self ):
        super().__init__(
            ...
            comments = _( "Shows VirtualBox™ virtual machines\nand allows them to be started." ) )
    ...
    def bring_window_to_front(
        ...
        if self.is_session_type_x11():
            ...
            if number_of_windows_with_the_same_name == "0":
                ...
                window_list = shared.process_run( "wmctrl -l" )[ 0 ]
    ...
    def on_launch_virtual_box_manager( self ):
        ...
        def start_virtualbox_manager():
            shared.process_run(
                shared.process_run( "which VirtualBox" )[ 0 ] + " &",
                capture_output = False )
        ...
        if self.is_session_type_x11():
            ...
            window_information = shared.process_run( command )[ 0 ]
    ...
    def get_running_virtual_machines( self ):
        ...
        '''
        running_vms = shared.process_run( "VBoxManage list runningvms" )[ 0 ]
        names = [ ]
        uuids = [ ]
    ...
    def is_virtual_machine_running(
        ...
        return uuid in shared.process_run( command )[ 0 ]
    ...
    def is_vboxmanage_installed( self ):
        which_vboxmanage = shared.process_run( "which VBoxManage" )[ 0 ]
