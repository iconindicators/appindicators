...
#
# I think this is because pip now needs to be run in a venv.
# If that is the case will impact (in some way which I do not know)
# the installation of ephem and sgp4 (and eventually skyfield).
# What to do...?
#
