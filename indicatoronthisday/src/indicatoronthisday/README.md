...
During the course of normal operation, the indicator may write to the cache at `$HOME/.cache/indicatoronthisday` and the config at `$HOME/.config/indicatoronthisday`.
