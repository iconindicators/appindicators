...
class IndicatorLunar( IndicatorBase ):
    ...
    if astroBackendName == astroBackendPyEphem:
        CREDIT = [ astroBackend.getCredit(), CREDIT_ECLIPSES, CREDIT_MINOR_PLANETS, CREDIT_SATELLITES ]

    else:
        CREDIT = [ astroBackend.getCredit(), CREDIT_ECLIPSE_SOLAR_ONLY, CREDIT_MINOR_PLANETS, CREDIT_SATELLITES ]
    ...
    def updateData( self, utcNow ):
        # Update comet data.
        # Commented out until comets are resolved.
