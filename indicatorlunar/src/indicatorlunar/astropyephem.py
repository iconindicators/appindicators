...
#TODO I think this is redundant...but now have to recall
# how to load up stars using supplied pyephem star db.
    ...
    def _calculate_stars(
        ...
        for star in stars:
            ...
            body = ephem.star( star.title() ) #TODO Ensure this works...instead of the line above.  If so, remove line above and comment too.
            body.compute( observer )
            if body.mag <= apparent_magnitude_maximum:
                AstroPyEphem._calculate_common(
                    data,
