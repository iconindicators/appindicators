...
#TODO When I used weight_set in indicatortest but using a ListStore (not TreeStore)
# was getting:
#  Warning: unable to set property 'weight-set' of type 'gboolean' from value of type '(null)'
#  dialog.show_all()
#
