...
class IndicatorScriptRunner( IndicatorBase ):
    ...
    def __init__( self ):
        ...
        #
        #     print( "stdout:" )
        #     print( result.stdout.decode() ) #TODO Add strip?
        #
        ...
        #         print( e.stdout.decode() ) #TODO Add strip?
    ...
    def getx( self, command ):
        ...
        try:
            ...
            print( "stdout:" )
            print( result.stdout.decode() ) #TODO Add strip?
            result = result.stdout.decode().strip() #TODO Add strip?
    ...
    def process_run( self, command ):
        ...
        try:
            ...
            # print( result.stdout.decode() ) #TODO Add strip?
            # result = result.stdout.decode() #TODO Add strip?
    ...
    def on_remove(
        ...
        self._update_entry_indicator_text(
            entry_indicator_text, old_tag_new_tag_pairs )
        ...
        if response == Gtk.ResponseType.OK:
            ...
            if model.iter_n_children( iter_group ) > 1:
                ...
                if iter_previous:
                    ...
                    iter_select = model.iter_next( iter_script )
...
#TODO For testing
    ...
    def _select_row(
        ...
        iter_as_string = treeview.get_model().get_string_from_iter( iter_ )
        treepath = Gtk.TreePath.new_from_string( iter_as_string )
        treeview.expand_all()
