...
#TODO UKHO website is changing soon (as of May 2017)...what is the effect?
...
class IndicatorTide:
    ...
    def _onPreferences( self, widget ):
        ...
        showAsSubmenusExceptFirstDayCheckbox.set_margin_left( pythonutils.WIDGET_INDENT_LEFT )
