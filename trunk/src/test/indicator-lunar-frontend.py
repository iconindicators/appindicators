...
# Test script.
# Run the backend once to calculate all astro information.
# Every minute update the frontend (GUI/menu). 
# Start at 10:20 using 133 MB
#     At 11:30 using 155 MB
#     At 14:30 using 156 MB
#     At 16:00 using 156 MB
# Finish at 16:40 using using 156 MB
#
