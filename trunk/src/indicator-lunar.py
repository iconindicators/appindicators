...
#         print( lunarEclipses.getInfo( 1 ) )
#         print( lunarEclipses.getEclipseForUTC( ephemNow ) )
#         print( lunarEclipses.getEclipseForUTC( ephem.localtime( ephemNow ) ) )

        lunarEclipses.getLunarEclipseForUTC( ephemNow )
...
class Eclipses:
    ...
    lunarEclipses =[ [ "2014", "Apr", "15", "07:46:48", "69", "T", "10S", "116W" ],
    ...
    def getLunarEclipseForUTC( self, dateTimeUTC ):
        self.getEclipseForUTC( self.lunarEclipses, dateTimeUTC )
        return self.lunarEclipses[ 0 ]


    def getSolarEclipseForUTC( self, dateTimeUTC ):
        eclipse = self.getEclipseForUTC( self.solarEclipses, dateTimeUTC )
        return self.lunarEclipses[ 0 ]


    def __getEclipseForUTC( self, list, dateTimeUTC ):
