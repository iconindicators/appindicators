...
#                     if "We wanted to build the chat system of the future" not in self.fortune:
#                         continue
# 
#                     print( self.fortune )
#                     i=0
#                     while i < len( self.fortune ):
#                         x = self.fortune[ i ]
#                         if i == 156:
#                             a = 0
#                         i += 1
...
#                     fontName = settings.get_string( "font-name" )
#                     print( fontName )

#                     documentFontName = settings.get_string( "document-font-name" )
#                     print( documentFontName )
