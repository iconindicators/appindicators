...
class IndicatorFortune:
    ...
    def _onPreferences( self, widget ):
        ...
        radioMiddleMouseClickNewFortune.set_margin_left( 20 )
        ...
        radioMiddleMouseClickCopyLastFortune.set_margin_left( 20 )
        ...
        radioMiddleMouseClickShowLastFortune.set_margin_left( 20 )
