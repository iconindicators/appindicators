...
class PreferencesFortuneIndicatorDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesFortuneIndicatorDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesFortuneIndicatorDialog object.
        """
        builder = get_builder('PreferencesFortuneIndicatorDialog')
        new_object = builder.get_object("preferences_fortune_indicator_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesFortuneIndicatorDialog object with it in order to
        finish initializing the start of the new PerferencesFortuneIndicatorDialog
        instance.
        ...
        self._db_name = "fortune-indicator"
        ...
        self._record_type = (
            "http://wiki.ubuntu.com/Quickly/RecordTypes/FortuneIndicator/"
            "Preferences")
        ...
        self.spinbutton_timeout.set_value(self._preferences["timeout"])

    def get_preferences(self):
        """Return a dict of preferences for fortune-indicator.
    ...
    def _load_preferences(self):
        ...
        self._preferences = {"record_type": self._record_type, "timeout": 10}
    ...
    def ok(self, widget, data=None):
        ...
        self._preferences["timeout"] = self.spinbutton_timeout.get_value()
...
if __name__ == "__main__":
    dialog = PreferencesFortuneIndicatorDialog()
    dialog.show()
    gtk.main()
